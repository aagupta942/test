...
public class SwaggerConfig {
	...
	public static final Contact DEFAULT_CONTACT = new Contact("Ayush Gupta", "http://ayush.learning.com",
			"ayush.learning.com");
	public static final ApiInfo DEFAULT_API_INFO = new ApiInfo("First Microservice", "My Learning methods", "1.0",
