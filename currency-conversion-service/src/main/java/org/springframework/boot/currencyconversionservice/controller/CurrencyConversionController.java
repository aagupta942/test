...
import org.springframework.boot.currencyconversionservice.CurrencyExchangeServiceProxy;
...
public class CurrencyConversionController {
	...
	public CurrencyConversionBean getConversionMultiple(@PathVariable String from, @PathVariable String to,
	...
	public CurrencyConversionBean getConversionMultipleFeign(@PathVariable String from, @PathVariable String to,
			@PathVariable BigDecimal quantity) {
